<template>
  <article class="flex min-h-full flex-col justify-center px-5 py-8 md:px-8">
    ...
    <p class="max-w-xl text-white/70">
      ...
      out of the box ideas. I have a passion for technical challenges and
      problem solving as well as a strong desire to learn and grow. I am always
      looking for new opportunities to expand my knowledge and skills, and I am
